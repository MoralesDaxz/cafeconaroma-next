...
const CardsInfo = () => {
  return (
    <section className="bgCards py-8 w-full text-black flex flex-col items-center justify-center gap-7 ">
      <h2 className=" text-white text-[1.5rem] font-medium opacity-90">
