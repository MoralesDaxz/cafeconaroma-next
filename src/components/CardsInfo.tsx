  ...
  return (
    <section className="bgCards py-14 w-full text-black flex flex-col items-center sm:min-h-[500px] justify-center gap-8 ">
      ...
      <article className="flex flex-col items-center justify-center sm:flex-row sm:items-center  gap-5">
        <div className="w-[75%] sm:w-[30%] lg:w-[300px] h-[17rem] flex flex-col items-center justify-start gap-4 bg-[#f0f0f0b4] backdrop-blur-[2px] rounded-tl-[50px] rounded-tr-[50px] rounded-br-[50px] p-4">
          <Image
            className="w-[25%]"
            src={check}
            width={500}
        ...
        <div className="w-[75%] sm:w-[30%] lg:w-[300px] py-4 px-6 h-[17rem] bg-[#f0f0f0b4] backdrop-blur-[2px] rounded-[60px] flex flex-col items-center justify-start gap-4 p-4">
          <Image
            className="w-[25%]"
            src={truck}
            width={500}
        ...
        <div className="w-[75%] sm:w-[30%] lg:w-[300px] h-[17rem] flex flex-col items-center justify-start gap-4 bg-[#f0f0f0b4] backdrop-blur-[2px] rounded-tr-[50px] rounded-tl-[50px] rounded-bl-[50px] p-4">
          <Image
            className="w-[25%]"
            src={gift}
            width={500}
