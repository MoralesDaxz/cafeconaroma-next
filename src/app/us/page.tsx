...
const page = () => {
  ...
  return (
    <section className="bg-us pt-20 pb-8 md:pt-28 min-h-screen text-[#d8d7d7] flex flex-col items-center gap-5 px-2 sm:px-5">
      ...
      <article className="w-full md:w-[90%] lg:w-[70%] flex flex-col items-center gap-5 bg-[#1b1b1bad] backdrop-blur-sm p-8 rounded-md">
        <p className={prfStyle}>
          ...
          <b> distribución abarca tanto el ámbito nacional como internacional
          </b>
        ...
        <p className={prfStyle}>
          valoramos la tradición y la innovación. Nos enorgullece colaborar con
          más de 30 empresas aliadas, asegurando que nuestro café llegue fresco
          y con el mejor sabor posible a cada rincón del mundo, ofreciendo una
        ...
        <p className={prfStyle}>
          ...
          reconocidos por nuestra innovación y calidad. Queremos ser la elección
          preferida de los amantes del café en todo el mundo, consolidándonos
          como una marca que representa tradición, pasión y excelencia.
        </p>
      </article>
      <h2 className="title my-6">Un poco de nuestro día a día.</h2>
      <article className="w-full bg-[#1b1b1bad] backdrop-blur-sm px-2 py-4 rounded-md">
        <GridGaleryUs />
      </article>
    </section>
  );
